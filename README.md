# 📘 Codeforces Pattern-Based Problem Sheet (14 Patterns)

This repository contains a **pattern-wise curated list of Codeforces
problems** categorized by **Easy, Medium, and Hard** difficulty levels.\
It is designed for **DSA preparation, interviews, and competitive
programming**.
...
-   https://codeforces.com/problemset/problem/1191/C

------------------------------------------------------------------------

## 1️⃣4️⃣ Dynamic Programming (Intro)
...
-   Solve **Easy → Medium → Hard**
-   Note the **core idea** after each problem
-   Revisit unsolved problems after 7 days
